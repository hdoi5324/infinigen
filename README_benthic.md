> **Current install:** this tree is Infinigen **v1.11.2 + benthic overlay**. Recreate from [`README_benthic_4_2.md`](README_benthic_4_2.md) or `git clone --recurse-submodules -b benthic-v1.11.2 https://github.com/hdoi5324/infinigen.git`. Do not copy `infinigenBenthic` onto a fresh Infinigen clone.
